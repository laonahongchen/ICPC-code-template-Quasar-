...
\subsection{杜教筛}
\cppcode{Math/djs.cpp}

\subsection{拉格朗日乘数法}
\cppcode{Math/LagrangePolar.cpp}
...
\subsection{NTT}
\cppcode{polynomial/NTT.cpp}

\subsection{FFT}
\cppcode{polynomial/FFT.cpp}


\subsection{多项式求逆开根}
\cppcode{polynomial/sqrt+inv.cpp}

\subsection{分治NTT}
\cppcode{polynomial/dcNTT.cpp}
...
\section{图论}
\subsection{点双连通分量}
\cppcode{Graph_Theory/ver-bcc.cpp}
...
\subsection{圆方树}
\cppcode{Graph_Theory/rsTree.cpp}
...
\subsection*{广义SAM}
\cppcode{String/exsam.cpp}

\subsection{后缀数组}
\cppcode{String/sa.cpp}

\subsection{回文自动机}
\cppcode{String/palinauto.cpp}
...
\subsection{DP优化}
\subsubsection{决策单调性}
\cppcode{dp_opt/monotomy.cpp}

\subsubsection{斜率优化}
\cppcode{dp_opt/slope.cpp}
